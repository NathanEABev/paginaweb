...
Os videos hospedados no sites são propriedades intelectuais de [viniccius13](https://www.youtube.com/user/viniccius13), este que não possui relação com o criador do site

O site serve apenas como uma homenagem ao youtuber, não possui fins lucrativos.
